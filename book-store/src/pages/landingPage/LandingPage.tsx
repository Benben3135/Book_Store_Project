    ...
    <div className=" h-full w-full bg-gradient-to-r from-cyan-200 to-blue-200 group">
      ...
      <div className=" hidden md:flex flex-row w-full items-center justify-center py-8">
        <div className=" flex flex-row w-1/3 items-center justify-center gap-4">
          <Button onClick={() => navigate("/login")} variant="secondary" className=" w-64 font-sans font-bold antialiased">Jump inside your library!</Button>
          <Button onClick={() => navigate("/register")} variant="default" className=" w-64 font-sans font-bold antialiased">Don't have a library?</Button>
        </div>
      </div>
    </div>
  );
